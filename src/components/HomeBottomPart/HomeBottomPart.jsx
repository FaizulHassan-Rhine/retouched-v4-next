        ...
        <div className='pt-[80px] pb-[80px] md:pb-[185px]'>
            <div className='container mx-auto px-3 md:px-0'>
                <div className='flex flex-col justify-center'>
                    <div className='font-jakarta text-2xl md:text-4xl font-bold text-center lg:text-left'>
                        <h1>Want to access all the features?</h1>
                        <h3 className='text-[#009024] font-extrabold'>Sign Up today.</h3>
                    </div>
                    <div className='pt-[32px] flex flex-col items-center lg:items-start'>
                        <SignInSignUpBtn />
                    </div>
                    <div>
                        <div className='flex flex-col lg:flex-row items-center lg:justify-between gap-10 lg:gap-[27px] pt-[40px] md:pt-[62px]'>
                            <div className='flex flex-col lg:flex-row gap-[10px] items-center lg:items-start'>
                                ...
                                <div className='flex flex-col text-[#726C6C] text-sm font-medium text-center lg:text-left'>
