...
const HomeTopPartStatic = () => {
    return (
        <div>
            <div className='container mx-auto'>
                <div className='grid grid-cols-2 gap-[85px] pt-[37px] pb-[105px]'>
                    <div className='flex flex-col gap-[30px]'>
                        <div className='flex flex-col gap-[15px]'>
                            <h1 className='font-jakarta text-2xl font-bold'>Your All In One Background Removal Tool</h1>
                            <div>
                                <video
                                    muted
                                    playsInline
                        ...
                        <div className='flex flex-col gap-[27px]'>
                            <div className='flex gap-[10px] items-center'>
                                ...
                                <div className='flex flex-col text-[#726C6C] text-sm font-medium'>
                            ...
                            <div className='flex gap-[10px] items-center'>
                                ...
                                <div className='flex flex-col text-[#726C6C] text-sm font-medium'>
                                    ...
                                    <p>Let the professionals handle it with Professional Touch-up under 120 mins.</p>
                                </div>
                            </div>
                            ...
                            <div className='flex gap-[10px] items-center'>
                                <div className='w-10 flex'>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="38" viewBox="0 0 38 38" fill="none">
                                        <path d="M23.8229 28.5L23.0154 25.8606M18.1862 28.5L20.4535 21.0695C20.5406 20.786 20.6879 20.5834 21.0045 20.5834C21.3212 20.5834 21.47 20.786 21.5555 21.0695L23.0185 25.8606H19M11.0834 28.5V25.3334M11.0834 25.3334V22.1667C11.0834 21.0077 11.1705 20.5834 12.2107 20.5834H13.9017C14.8359 20.5834 15.5927 21.6474 15.5927 22.9584C15.5927 24.2694 14.8359 25.3334 13.9017 25.3334M11.0834 25.3334H13.9017M13.9017 25.3334L15.029 28.5M33.25 20.5834L32.6753 27.1795C32.6278 27.7385 32.6025 28.0187 32.422 28.071C32.243 28.1232 32.0578 27.9031 31.6905 27.4645L30.2211 25.7165C30.0216 25.479 29.9219 25.3603 29.7889 25.3603C29.6559 25.3603 29.5561 25.479 29.3566 25.7165L27.8873 27.4661C27.52 27.9047 27.3363 28.1232 27.1558 28.071C26.9769 28.0187 26.9515 27.7385 26.9025 27.1811L26.323 20.5834" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M23.75 34.8334H16.9844C11.8228 34.8334 9.23875 34.8334 7.44642 33.5699C6.93634 33.2122 6.48042 32.7829 6.09267 32.2953C4.75 30.6074 4.75 28.1786 4.75 23.3178V19.2882C4.75 14.5968 4.75 12.2503 5.49258 10.3772C6.68642 7.3641 9.21025 4.9891 12.4117 3.86494C14.4004 3.16669 16.891 3.16669 21.8785 3.16669C24.7253 3.16669 26.1503 3.16669 27.2872 3.56569C29.1159 4.20852 30.5583 5.56544 31.2408 7.28652C31.6667 8.35685 31.6667 9.69794 31.6667 12.3785V15.8334" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M4.75 19C4.75 17.6004 5.30599 16.2581 6.29567 15.2684C7.28535 14.2788 8.62764 13.7228 10.0273 13.7228C11.0817 13.7228 12.3247 13.9064 13.3491 13.6325C13.7967 13.5121 14.2048 13.276 14.5324 12.9481C14.8601 12.6202 15.0957 12.2119 15.2158 11.7642C15.4897 10.7398 15.3061 9.49685 15.3061 8.44235C15.3065 7.04301 15.8627 5.70113 16.8523 4.7118C17.8419 3.72246 19.184 3.16669 20.5833 3.16669" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <div className='flex flex-col text-[#726C6C] text-sm font-medium'>
                    ...
                    <div className='flex flex-col gap-[26px]'>
                        <div className='flex flex-col gap-[15px]'>
                            <h1 className='font-jakarta text-2xl font-bold'>Upload single pictures or in batch</h1>
                            <div className='h-[404px] border-[2px] border-solid border-black rounded-xl flex items-center justify-center'>
                                <div className='flex flex-col justify-center items-center gap-3'>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="62" height="62" viewBox="0 0 62 62" fill="none">
                                            <path d="M31.0103 52.9583L31 29.7083M52.3358 44.3248C54.4044 42.8702 55.9556 40.7942 56.7644 38.3982C57.5731 36.0021 57.5973 33.4107 56.8334 31C55.2666 26.0529 50.4654 23.3417 45.2768 23.3469H42.2788C41.5634 20.5577 40.2246 17.9671 38.363 15.7702C36.5015 13.5734 34.1658 11.8275 31.5318 10.664C28.8979 9.50048 26.0343 8.94971 23.1566 9.05315C20.279 9.15659 17.4623 9.91153 14.9187 11.2611C12.375 12.6107 10.1707 14.5198 8.47174 16.8447C6.77273 19.1695 5.62331 21.8495 5.11 24.6829C4.5967 27.5163 4.73289 30.4292 5.50833 33.2023C6.28377 35.9754 7.67825 38.5365 9.58677 40.6927" stroke="#5A5555" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M39.2202 35.6965L31 27.4763L22.7798 35.6965" stroke="#5A5555" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </span>
                                    <p className='text-[#255646] text-xs text-center font-bold'>Or drag & drop a file</p>
                                    <p className='text-[#255646] text-xs text-center font-bold'>Or paste URL</p>
                                </div>
                            </div>
                        </div>
                        <div className='flex flex-col gap-3'>
                            <p className='text-xs font-bold text-black'>No Images? You can try any of the samples from below</p>
                            <div className='flex gap-[14px]'>
                                <button className='flex flex-col justify-center items-center w-[78px] h-[55px] overflow-hidden'><img className='max-w-none h-full' src='./images/v-4/sample-1.jpg' /></button>
                                <button className='flex flex-col justify-center items-center w-[78px] h-[55px]  overflow-hidden'><img className='w-full' src='./images/v-4/sample-2.jpg' /></button>
                                <button className='flex flex-col justify-center items-center w-[78px] h-[55px]  overflow-hidden'><img className='w-full' src='./images/v-4/sample-3.jpg' /></button>
                                <button className='flex flex-col justify-center items-center w-[78px] h-[55px]  overflow-hidden'><img className='w-full' src='./images/v-4/sample-4.jpg' /></button>

                            </div>
                        </div>
                        <p className='text-[#255646] text-sm font-medium'>By uploading an image or URL you agree to our Terms of Service. To learn more about how Retouched.ai handles your personal data, check our Privacy Policy.</p>
                    </div>
                </div>
            </div>
        </div>
...
export default HomeTopPartStatic;