                      ...
                      <div className="flex flex-col gap-[10px] pt-[14px]">
                        ...
                        <div>
                          <div
                            // to="/reset-password"
                            onClick={showDiv3}
                            className="text-[10px] cursor-pointer underline font-normal text-[#726C6C]"
                          >
                            Forgot password?
                          </div>
                        </div>
                      ...
                      <form onSubmit={resetPassFunc}>
                        <div className="mb-6">
                          ...
                          <input
                            ...
                            type="email"
                            id="lostPassId"
                            className="border-[1px] bg-white py-[6px] w-full pl-[10px] rounded pr-[40px] border-solid border-[#5A5555] text-xs font-normal"
                            placeholder="example@example.com"
                          />
                        </div>
